 ...
 */
class CodiceFiscaleC {
  constructor(props) {
    this.props = props;
    this.calcola_carattere_di_controllo = this.calcola_carattere_di_controllo.bind(this);
    this.affronta_omocodia = this.affronta_omocodia.bind(this);
    this.ottieni_consonanti = this.ottieni_consonanti.bind(this);
    this.ottieni_vocali = this.ottieni_vocali.bind(this);
    this.calcola_codice_cognome = this.calcola_codice_cognome.bind(this);
    this.calcola_codice_nome = this.calcola_codice_nome.bind(this);
    this.calcola_codice_data = this.calcola_codice_data.bind(this);
    this.trova_comune = this.trova_comune.bind(this);
    this.solo_comuni = this.solo_comuni.bind(this);
    this.calcola_codice_comune = this.calcola_codice_comune.bind(this);
    this.calcola_codice = this.calcola_codice.bind(this);
    this.tavola_mesi = ['A', 'B', 'C', 'D', 'E', 'H', 'L', 'M', 'P', 'R', 'S', 'T'];
    this.tavola_omocodie = ['L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V'];
    ...
    this.codici_catastali = {
      ...
      "Z735": "MICRONESIA STATI FEDERALI",
  ...
  affronta_omocodia(codice_fiscale, numero_omocodia) {
// non funziona
  ...
  calcola_codice_data(gg, mm, aa, sesso) {
    var d = new Date()
    d.setYear(aa);
    d.setMonth(mm - 1);
    d.setDate(gg);
  ...
  trova_comune(pattern_comune) {
    return this.codici_catastali[pattern_comune];
    /* *
  ...
  solo_comuni() {
    var array = [], codici = this.codici_catastali;
    for (let i in codici) {
      var comune = codici[i].split(" (")[0], provincia = "";
      if (codici[i].split(" (")[1]) {
        provincia = codici[i].split(" (")[1].split(")")[0];
      }
      var obj = {
        "codice_catasto": i,
  ...
  calcola_codice_comune(pattern_comune) {
    console.info("località:", pattern_comune);
    var i, comune, codice = [], self = this;
    for (i in this.codici_catastali) {
      comune = self.codici_catastali[i];
      if (pattern_comune.toLowerCase() == (comune.toLowerCase()).slice(0, -5)) {
        //comune.indexOf(pattern_comune) == 0
        console.log("codice valido", i);
        codice.push(i);
      }
    }
    return codice[0];
  ...
  calcola_codice(nome, cognome, sesso, giorno, mese, anno, luogo) {
    var codice =
...
export const CodiceFiscale = new CodiceFiscaleC();